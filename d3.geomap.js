...
// calculates average annual change over 50-year period
function get_avg_pct_changes(country) {
    ...
    chg_50 = tool_format(chg_50) + "%"; // format % change
    ...
    _createClass(Geomap, [{
        ...
        value: function draw(selection, self) {
            ...
            self.svg = selection.append('svg')
                ...
                .attr('height', 0.84*self.properties.height);
            ...
            var proj = self.properties.projection()
...
var Choropleth = (function (_Geomap) {
    ...
    _createClass(Choropleth, [{
        ...
        value: function draw(selection, self) {
            ...
            _get(Object.getPrototypeOf(Choropleth.prototype), 'draw', this)
                .call(this, selection, self);
        }
    }, {
        key: 'update',
        value: function update() {
            ...
            self.createTooltip(0.06*innerWidth, 0.46*innerHeight);
        ...
        value: function drawLegend() {
            ...
            var legend = self.svg.append('g')
                ...
                .attr('width', wBox)
                .attr('height', hBox)
                .attr('transform', 'translate('+ (self.properties.width - 0.6*wBox) + ', 0)');

            legend.append('rect')
                .style('fill', '#fff')
                .attr('class', 'legend-bg')
                .attr('width', 0.60*wBox)
                .attr('height', hBox);
